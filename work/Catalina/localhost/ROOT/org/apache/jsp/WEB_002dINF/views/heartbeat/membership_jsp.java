 ...
 * Generated at: 2024-11-25 12:51:10 UTC
...
public final class membership_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/popup/pop-alert-Logout.jsp", Long.valueOf(1732522992956L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if (pageRequest.endsWith("index.jsp")) pageName = "HeartBeat";
      ...
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("    function artistPayShow() {\r\n");
      out.write("        $('.artist').show();\r\n");
      out.write("        $('.dimmed').show();\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    function payhide() {\r\n");
      out.write("        $('.pop-pay').hide();\r\n");
      out.write("        $('.dimmed').hide();\r\n");
      out.write("    }\r\n");
      out.write("    \r\n");
      out.write("    function streamingPayShow() {\r\n");
      out.write("        $('.streaming').show();\r\n");
      out.write("        $('.dimmed').show();\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    function pay2hide() {\r\n");
      out.write("        $('.streaming').hide();\r\n");
      out.write("        $('.dimmed').hide();\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    // 부모 페이지에서 pgToken을 받는 함수\r\n");
      out.write("    function receivePgToken(pgToken) {\r\n");
      out.write("        console.log(\"Received PG Token:\", pgToken);\r\n");
      out.write("        \r\n");
      out.write("        // 서버로 결제 정보 전송\r\n");
      out.write("        $.ajax({\r\n");
      out.write("            type: 'POST',\r\n");
      out.write("            url: '/membership/processPayment',  // 결제 처리 URL\r\n");
      out.write("            contentType: 'application/json',\r\n");
      out.write("            data: JSON.stringify({ pg_token: pgToken }),\r\n");
      out.write("            success: function(response) {\r\n");
      out.write("                if (response.success) {\r\n");
      out.write("                    alert('결제가 완료되었습니다.');\r\n");
      out.write("                    payhide();  // 결제 완료 후 팝업 닫기\r\n");
      out.write("                } else {\r\n");
      out.write("                    alert('결제 확인에 실패하였습니다.');\r\n");
      out.write("                }\r\n");
      out.write("            },\r\n");
      out.write("            error: function(xhr, status, error) {\r\n");
      out.write("                console.error('결제 처리 중 오류 발생:', error);\r\n");
      out.write("                alert('결제 처리 중 오류가 발생하였습니다.');\r\n");
      out.write("            }\r\n");
      out.write("        });\r\n");
      out.write("    }\r\n");
      out.write("</script>\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("    <div class=\"inner service membership\" data-name=\"membership\">\r\n");
      out.write("        ");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
	...
	String mypage =	menuPageRequest.endsWith("mypage.jsp") ? "on" : "";
      ...
      out.write("                <h2 id=\"title\" class=\"title\"></h2>\r\n");
      out.write("                <div class=\"cntArea\">\r\n");
      out.write("                    <div class=\"section-membership\">\r\n");
      out.write("                        <div class=\"tit\">지금 멤버십을 구독하세요! <br>Hot한 음악도 마음껏 듣고 내가 좋아하는 아티스트와 소통하고 팬들도 사귈 수 있는 기회!</div>\r\n");
      ...
      out.write("</div>\r\n");
      out.write("                        <ul class=\"itemCnt\">\r\n");
      out.write("				    <li class=\"item ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${UserVO.level == 1 ||UserVO.level == 2 ? 'disabled' : '' }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\">\r\n");
      out.write("				        <p class=\"thumb\"><i class=\"fa-solid fa-coins\"></i></p>\r\n");
      out.write("				        <p class=\"info\">\r\n");
      out.write("				            <span class=\"grade\">Level 1</span>\r\n");
      out.write("				            <span>단일 스트리밍 이용권</span>\r\n");
      out.write("				        </p>\r\n");
      out.write("				        <p class=\"price\">3,900원</p>\r\n");
      out.write("				        <button type=\"button\" class=\"btn-full\" onclick=\"streamingPayShow()\" ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${UserVO.level == 1 ||UserVO.level == 2 ? 'disabled' : '' }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write(">구매하기</button>\r\n");
      out.write("				    </li>\r\n");
      out.write("				    <li class=\"item ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${UserVO.level == 2 ? 'disabled' : ''}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\">\r\n");
      out.write("				        <p class=\"thumb\"><i class=\"fa-solid fa-coins\"></i></p>\r\n");
      out.write("				        <p class=\"info\">\r\n");
      out.write("				            <span class=\"grade\">Level 2</span>\r\n");
      out.write("				            <span>스트리밍 이용권 + 아티스트 구독</span>\r\n");
      out.write("				        </p>\r\n");
      out.write("				        <p class=\"price\">6,900원</p>\r\n");
      out.write("				        <!-- 구매하기 버튼 클릭 시 artistPayShow() 호출 -->\r\n");
      out.write("				        <button type=\"button\" class=\"btn-full\" onclick=\"artistPayShow()\" ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${UserVO.level == 2 ? 'disabled' : '' }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write(">구매하기</button>\r\n");
      out.write("				        <p>");
      ...
      out.write("</html>\r\n");
      out.write("	<!-- [D] 팝업 로그아웃-->\r\n");
      out.write("	<div class=\"popup pop-alert-logout\" >");
      out.write("\r\n");
      out.write("\r\n");
      out.write("<div class=\"wrap\">\r\n");
      out.write("	<div class=\"topArea\">\r\n");
      out.write("		<div class=\"title\">로그아웃</div>\r\n");
      out.write("		<button type=\"button\" class=\"btn-i-close\" onclick=\"popLogoutHide();\"></button>\r\n");
      out.write("	</div>\r\n");
      out.write("	<div class=\"cntArea\">\r\n");
      out.write("		<div class=\"messageBx\">\r\n");
      out.write("			<p>로그아웃을 하시겠습니까?</p>\r\n");
      out.write("			<div class=\"btnWrap\">\r\n");
      out.write("				<button type=\"button\" class=\"btn-full\" onclick=\"popLogoutHide();\">로그아웃</button>\r\n");
      out.write("				<button type=\"button\" class=\"btn-border\" onclick=\"popLogoutHide();\">닫기</button>\r\n");
      out.write("			</div>\r\n");
      out.write("		</div>\r\n");
      out.write("	</div>\r\n");
      out.write("</div>");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/heartbeat/membership.jsp(54,0) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_c_005fif_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("        alert(\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${alertMsg}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
          out.write("\");  // 서버에서 전달한 경고 메시지 표시\r\n");
          out.write("        window.location.href = \"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
          out.write("/membership\";  // 경고 후 리디렉션\r\n");
          out.write("    </script>\r\n");
