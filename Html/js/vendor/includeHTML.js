...
function includeInitial(){
	...
	var $href = $('li>a[href="/Html/Html/heartbeat/'+ $page +'.html"]');
	var $commHref = $('li>a[href="/Html/Html/community/'+ $page +'.html"]');
	
	$href.addClass('on');
	$commHref.addClass('on');
	
	var $adminPage = $('.admin').attr('data-name');
	var $adminHref = $('li>a[href="/Html/Html/admin/'+ $adminPage +'.html"]');

	$adminHref.addClass('on');
}
