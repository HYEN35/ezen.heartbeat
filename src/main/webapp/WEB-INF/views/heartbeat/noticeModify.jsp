...
<body>
	<div class="inner service notice-edit" data-name="notice">
				...
				<div class="cntArea">
					<form action="/notice/noticeModify" method="post">
						...
						<div class="btnWrap">
							...
							<a href="/notice/getPostOne?notice_id=${noticeVO.notice_id }&num=${num}&searchType=${searchType}&keyword=${keyword}" class="btn-border">취소</a>
						</div>
					</form>
				</div>
			</div>
