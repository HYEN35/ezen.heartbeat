			...
			<div class="wrap">
				...
				<div class="loginCnt">
					<form action="/login" method="post" autocomplete="off">
						<div id="id" class="item">
							<p>이메일</p>
							<input type="text" name="email" class="txtBx" placeholder="E-mail 입력" value="USER10@USER.COM">
							 <c:if test="${email == false}"><p class="error" style="display: block;" >이메일을 확인해주세요.</p></c:if>
						</div>
						<div id="password" class="item">
							<p>비밀번호</p>
							<input type="password"  name="pwd" class="txtBx" placeholder="비밀번호 입력" value="ASAS1212!">
